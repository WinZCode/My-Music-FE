    ...
    return (
        <div className='px-[59px] mt-12 relative max-h-[430px] rounded-md'>
            ...
            <div className='absolute top-0 z-20 left-[59px] right-[59px] bottom-0 p-5 flex flex-col gap-8 rounded-md'>
                <Link
                    to={path.ZING_CHART}
                    className='flex gap-2 items-center  text-white hover:text-green-700'
                >
                    <h3 className='text-2xl  font-bold '>#zingchart</h3>
                    <span className='text-green p-1 rounded-full bg-white'>
                        <BsFillPlayFill size={20} color='green' />
                    </span>
                </Link>
                <div className='flex gap-4 h-full'>
                    <div className='flex-3 flex flex-col gap-4'>
                        ...
                        <Link
                            to={path.ZING_CHART}
                            className='text-white px-4 py-2 rounded-l-full rounded-r-full border border-white w-fit m-auto flex items-center'
                        >
                            Xem thêm
                        </Link>
                    </div>
